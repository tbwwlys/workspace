...
onMounted(async () => {
  ...
  for(let i = 0; i < data.length; i++) {
    ...
    heights[minHeightIndex] += data[i].height // 累加所有图片的height
  }
...
<div class="page">
  ...
  <main class="wrapper"> 
    <!-- <div class="col">
      <div class="item" v-for="goods in state.leftGoods" :key="id">
        <div>
    ...
    <div class="col">
      <GoodsItem v-for="goods in state.leftGoods" :key="goods.id" :goods="goods"></GoodsItem>
    </div>
    <div class="col">
      <GoodsItem v-for="goods in state.rightGoods" :key="goods.id" :goods="goods"></GoodsItem>
    </div>
  </main>
  <footer >
